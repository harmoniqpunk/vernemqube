...
# Enable SSL
#echo "listener.ssl.default = ${IP_ADDRESS}:8883" >> /etc/vernemq/vernemq.conf
#echo "listener.ssl.cafile = /etc/ssl/cacerts.pem" >> /etc/vernemq/vernemq.conf
#echo "listener.ssl.certfile = /etc/ssl/cert.pem" >> /etc/vernemq/vernemq.conf
#echo "listener.ssl.keyfile = /etc/ssl/key.pem" >> /etc/vernemq/vernemq.conf
